    ...
    public partial class frmEmployee : XtraForm
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //}
                ...
                varinsert.insertToEmployee(txtEmpCode.Text, txtLastName.Text, txtFirstName.Text, txtOname.Text, txtAge.Text, cboGender.SelectedItem.ToString(), txtContact.Text, txtEmail.Text.ToLower(), dtpDateJoined, cboDepartment.SelectedItem.ToString(), txtDesignation.Text, txtQaulification.Text, txtResAddress.Text, picImage);
