...
{
    public partial class frmupdateEmployee : XtraForm
    {
        ...
        public void selectEmployeeDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select empSname,empFname,empOname,age,empGender,empContact,empEmail,empDateJoined,empDepartment,empDesignation,empQualification,empResidenceAddress,epmPhoto from tblEmployees  where empCode = '" + txtEmpCode.Text.Trim() + "'", con);
        ...
        void updateEmployeeDetails(string empSname, string empFname, string empOname, string age, string empGender, string empContact, string empEmail,  DateTimePicker empDateJoined, System.Windows.Forms.ComboBox empDepartment, string empDesignation, string empQualification, string empResidenceAddress , PictureBox epmPhoto)
        {
            ...
            try
            {
                ...
                updateBillString = "update tblEmployees set empSname =@empSname,empFname =@empFname, empOname =@empOname,age=@age ,empGender=@empGender, empContact=@empContact ,empEmail =@empEmail , empDateJoined=@empDateJoined,empDepartment = @empDepartment,empDesignation=@empDesignation ,empQualification=@empQualification,empResidenceAddress=@empResidenceAddress ,epmPhoto=@epmPhoto  where empCode = '" + txtEmpCode.Text.Trim() + "'";
        ...
        void saving()
        {
            ...
            {
                //updateEmployeeImage();
                updateEmployeeDetails(txtLastName.Text,txtFirstName.Text,txtOname.Text,txtAge.Text,cboGender.SelectedItem.ToString(),txtContact.Text,txtEmail.Text,dtpDateJoined,cboDepartment,txtDesignation.Text,txtQaulification.Text,txtResAddress.Text,picImage);
                RESETTING();
