...
namespace Onana_Hospital_Management_System
{
    public partial class frmUsers : XtraForm
    {
      ...
      void validateConfirmPass(Control ctrl)
      {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    MessageBox.Show("Password mismatch !", "Error - MediSphere", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
        ...
        // insert
        public void Valinput(System.Windows.Forms.ComboBox cobUser)
        {
            try
            {
                ...
                if (count == 1)
                {
                    MessageBox.Show("User Already Exist", "Save Data - MediSphere", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return;
                }
                else
                {
