...
namespace Onana_Hospital_Management_System
{
    public partial class frmPatient : XtraForm
    {
        ...
        void clearAll()
        {
            txtPatCode.Text = "HD-" + selectCalss.callGenPatientNo();
...

        {
            ...
            if (err.GetError(txtLastName).Length !=0)  {
               ...
               //varinsert.tblpatientBill(txtPatCode.Text, fullName, folderBill);
                varinsert.insertToPatient(txtPatCode.Text, txtLastName.Text, txtFirstName.Text, txtOname.Text, cboGender,  txtResAddress.Text, txtContact.Text, pictureBox1,int.Parse(txtAge.Text));
