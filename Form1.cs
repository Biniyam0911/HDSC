...
namespace Onana_Hospital_Management_System
{
    public partial class Form1 : XtraForm
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter a value","MediSphere");
            }        
            else
            {
        ...
        public void Valinput(string dept)
        {
            try
            {
                ...
                if (count == 1)
                {
                    MessageBox.Show("Department Already Exist", "Save Data - MediSphere", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return;
                }
                else
                {
