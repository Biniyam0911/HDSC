    ...
    public partial class frmUpdatePassword : XtraForm
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Password mismatch", "Error Data - MediSphere", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        void selectUsers()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Invalid Username or Password or ID", "Error - MediSphere", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        {
            txtUserID.Text = selectClass.getEmpCode(username);
